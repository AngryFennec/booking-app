    ...
    def show_page(self):
        def new_table_create():
            if st.session_state.new_table_create:
                new_table = Table(name=st.session_state.new_table_name, seats=st.session_state.new_table_seats,
                                  free_seats=st.session_state.new_table_seats, free=True, checked=False)
